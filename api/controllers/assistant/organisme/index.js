 ...
 * @description Création d'un compteur organisme
 */
exports.createOrganisme = async (req, res) => {
    try {
        ...
        let mailOptions = {
            ...
            to: `${email},support@trainpreddict.fr`,
    ...
    Vous pouvez vous connecté au lien suivant http://trainpreddict.fr/assistant avec ce 
